						...
						<div class="col-xl-3 col-lg-4 col-md-12 theiaStickySidebar">
							<aside class="sidebar sidebar-user">
								...
								<div class="quicklink-sidebar-menu ctm-border-radius shadow-sm bg-white card">
									<div class="card-body">
										<ul class="list-group">
											<li class="list-group-item text-center active button-5"><a href="settings.html" class="text-white">General</a></li>
											<li class="list-group-item text-center button-6"><a class="text-dark" href="settings-timeoff.html">Time Off</a></li>
										</ul>
									</div>
								</div>
							</aside>
						...
						<div class="col-xl-9 col-lg-8  col-md-12">
							<div class="row">
								<div class="col-md-6 d-flex">
									<div class="card ctm-border-radius shadow-sm company-RohanLogo flex-fill">
