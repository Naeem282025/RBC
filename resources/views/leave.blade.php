                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-6">
                            <div class="logo my-3 my-sm-0">
                                <a href="index.html"> <img src="assets/img/RohanLogo.png" alt="logo image"
                                        ...
                                        <div class="user-info align-right dropdown d-inline-block header-dropdown">
                                            <a href="javascript:void(0)" data-toggle="dropdown"
                                                ...
                                                <div class="user-avatar d-inline-block">
                                                    <img th:src="@{'assets/img/profiles/' + ${image}}" alt="user avatar"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card ctm-border-radius shadow-sm">
                                    ...
                                    <div class="card-body">
                                        <!-- dmsdmsdmsdsd -->
                                        <form action="{{ url('/leaveData') }}" method="POST">
                                            @csrf
                                            <div class="row align-items-center">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select" name="leave_type"
                                                            ...
                                                            <option value="Working From Home"
                                                                {{ old('leave+type') == 'Working From Home' ? 'selected' : '' }}>
                                                                Working From Home</option>
                                                            <option value="Sick Leave"
                                                                {{ old('leave_type') == 'Sick Leave' ? 'selected' : '' }}>
                                                                Sick Leave</option>
                                                            <option value="Parental Leave"
                                                                {{ old('leave_type') == 'Parental Leave' ? 'selected' : '' }}>
                                                                Parental Leave</option>
                                                            <option value="Annual Leave"
                                                                {{ old('leave_type') == 'Annual Leave' ? 'selected' : '' }}>
                                                                Annual Leave</option>
                                                            <option value="Normal Leave"
                                                                {{ old('leave_type') == 'Normal Leave' ? 'selected' : '' }}>
                                                                Normal Leave</option>
                                                        </select>
                                                        @error('leave_type')
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" onfocus="(this.type='date')"
                                                            onblur="(this.type='text')" name="applied_date"
                                                            id="appliedDate" placeholder="Applied Date"
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" onfocus="(this.type='date')"
                                                            onblur="(this.type='text')" name="from_date"
                                                ...
                                                <div class="col-sm-6 leave-col">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="to_date" id="toDate"
                                                            placeholder="To" value="{{ old('to_date') }}"
                                        ...
                                        <div class="employee-office-table">
                                            <div class="table-responsive">
                                                <table class="table custom-table mb-0 table-hover">
                                                    ...
                                                    <tbody>
                                                        @forelse($leaveList ?? collect([]) as $index => $leave)
                                                            <tr>
                                                                ...
                                                                <td>{{ \Carbon\Carbon::parse($leave->applied_date)->format('Y-m-d') }}</td>
                                                                <td>{{ $leave->status }}</td> 
                                                            </tr>
                                                        @empty
                                                            <tr>
