									...
									<div class="col-lg-12 col-md-12 col-sm-12">
										...
										<div
											...
											<div
												...
												<a class="dropdown-item p-2" href="details.html"> <span
							...
							<div
								...
								<div class="append mr-auto my-0 my-md-0 mr-auto">
									<ul class="list-group list-group-horizontal-md mr-auto">
										<li class="active mr-1"><a href="index.html"
				...
				<div class="row">
					<div class="col-xl-3 col-lg-4 col-md-12 theiaStickySidebar">
						<aside class="sidebar sidebar-user">
							...
							<div
								class="user-card card shadow-sm bg-white text-center ctm-border-radius">
								<div class="user-info card-body">
									...
									<div class="user-details">
										<h4>
											<b>{{ session('Guest') }} {{ session('firstname') }}</b>
										</h4>
							...
							<div
								class="quicklink-sidebar-menu ctm-border-radius shadow-sm bg-white card">

								<div class="card-body">
									<ul class="list-group">
										<li class="list-group-item text-center button-6"><a
											href="index.html" class="text-dark">Admin Dashboard</a></li>
										<li class="list-group-item text-center active button-5"><a
											class="text-white" href="employees-dashboard.html">Employees
												Dashboard</a></li>
									</ul>
								</div>
							</div>
										...
										<div class="recent-comment">
											...
											<a href="javascript:void(0)" class="dash-card text-dark">
												<div class="dash-card-container">
													...
													<div class="dash-card-avatars">
														<div class="e-avatar">
															<img class="img-fluid"
																src="assets/img/profiles/img-9.jpg" alt="Avatar">
														</div>
													</div>
												</div>
											</a>
											...
											<a href="javascript:void(0)" class="dash-card text-dark">
												<div class="dash-card-container">
													...
													<div class="dash-card-avatars">
														<div class="e-avatar">
															<img class="img-fluid"
																src="assets/img/profiles/img-5.jpg" alt="Avatar">
														</div>
													</div>
												</div>
											</a>
											...
											<a href="javascript:void(0)" class="dash-card text-dark">
												<div class="dash-card-container">
													...
													<div class="dash-card-content">
														<h6 class="mb-0">John Gibbs is working from home
															today</h6>
													</div>
													<div class="dash-card-avatars">
														<div class="e-avatar">
															<img class="img-fluid"
																src="assets/img/profiles/img-2.jpg" alt="John Gibbs">
														</div>
													</div>
												</div>
											</a>
							...
							<div class="col-xl-6 col-lg-12 d-flex">
								...
								<div class="card flex-fill team-lead shadow-sm">
									<div class="card-header">
										...
										<a href="employees-team.html"
											class="dash-card d-inline-block float-right mb-0 text-primary">Manage
											Team </a>
									</div>
