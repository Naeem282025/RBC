                    ...
                    <div class="col-xl-3 col-lg-4 col-md-12 theiaStickySidebar">
                        <aside class="sidebar sidebar-user">
                            ...
                            <div class="quicklink-sidebar-menu ctm-border-radius shadow-sm bg-white card">
                                ...
                                <div class="card-body">
                                    <ul class="list-group">
                                        <li class="list-group-item text-center button-6"><a href="index"
                                                class="text-dark">Admin Dashboard</a></li>
                                        <li class="list-group-item text-center active button-5"><a class="text-white"
                                                href="employees-dashboard">Employees Dashboard</a></li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="row">
                                            ...
                                            @foreach (session('all_employees') as $employee)
                                                <div class="media mb-3">
                                                    ...
                                                    <div class="media-body">
                                                        <h6 class="m-0">{{ $employee->first_name }}
                                                            {{ $employee->last_name }}</h6>
                            ...
                            <div class="col-xl-6 col-lg-12 d-flex">
                                ...
                                <div class="card recent-acti flex-fill shadow-sm">
                                    ...
                                    <div class="card-body recent-activ admin-active">
                                        <div class="recent-comment">
                                            <div class="notice-board">
                                                <div class="table-img">
                                                    <div class="e-avatar mr-3"><img class="img-fluid"
                                                            src="assets/img/profiles/img-6.jpg" alt="Maria Cotton">
                                                    </div>
                                                </div>
												@if (isset($leaveList) && $leaveList->isNotEmpty())
												<div class="dash-card-content">
													<h6 class="mb-0">
														{{ \Carbon\Carbon::parse($leaveList->first()->applied_date)->format('D, d F Y') }}
													</h6>
												</div>
											@else
												<div class="dash-card-content">
													<h6 class="mb-0">No leave applications</h6>
												</div>
											@endif
                                            </div>
                                            <hr>
