...
<html lang="en">
	<head>
		...
		<title>Employees Dashboard Page</title>
								...
								<div class="header-menu-list d-flex bg-white rt_nav_header horizontal-layout nav-bottom">
									<div class="append mr-auto my-0 my-md-0 mr-auto">
										<ul class="list-group list-group-horizontal-md mr-auto">
											<li class="active mr-1"><a href="index.html" class="text-white btn-ctm-space"><span class="lnr lnr-home pr-0 pr-lg-2"></span><span class="d-none d-lg-inline">Dashboard</span></a></li>
								...
								<div class="quicklink-sidebar-menu ctm-border-radius shadow-sm bg-white card">
									...
									<div class="card-body">
										<ul class="list-group">
											...
											<li class="list-group-item text-center active button-5"><a class="text-white" href="employees-dashboard.html">Employees Dashboard</a></li>
										</ul>
									</div>
								</div>
											...
											<div class="recent-comment">
												...
												<a href="javascript:void(0)" class="dash-card text-dark">
													<div class="dash-card-container">
														...
														<div class="dash-card-avatars">
															<div class="e-avatar"><img class="img-fluid" src="assets/img/profiles/img-2.jpg" alt="John Gibbs"></div>
														</div>
													</div>
												</a>
												...
												@foreach(session('all_employees') as $employee)
													<div class="media mb-3">
														<div class="e-avatar avatar-online mr-3">
															<img src="{{ asset('assets/img/profiles/' . $employee->image_photo_url) }}" alt="{{ $employee->first_name }}" class="img-fluid">
														</div>
