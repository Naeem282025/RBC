											...
											<div class="col-md-12 mr-auto text-left">
												<div class="custom-search input-group">
													<div class="custom-breadcrumb">
														...
														<h4 class="text-dark">Line Managers</h4>
													</div>
												</div>
											</div>
										</div>
								...
								<div class="quicklink-sidebar-menu ctm-border-radius shadow-sm bg-white card">
									<div class="card-body">
										<div class="flex-column list-group" id="v-pills-tab" role="tablist" aria-orientation="vertical">
											...
											<a class="list-group-item" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-settings" role="tab" aria-controls="v-pills-settings" aria-selected="false">View Others Information </a>
										</div>
									</div>
								</div>
							</aside>
						...
						<div class="col-xl-9 col-lg-8  col-md-12">
							<div class="card ctm-border-radius shadow-sm">
								<div class="card-header">
									<h4 class="card-title mb-0 d-inline-block">Your Line Managers</h4>
								</div>
								<div class="card-body">
									...
									<span class="ml-4">1 Line Manager</span>
									</a>
								</div>
							</div>
							<div class="card ctm-border-radius shadow-sm">
												...
												<table class="table admin-table table-hover">
													...
													<tbody>
														<tr>
															...
															<td>
																<div class="custom-control custom-switch">
																	<input type="checkbox" class="custom-control-input" id="switch27" disabled>
														...
														<tr>
															...
															<td class="pb-0">
																<div class="custom-control custom-switch">
																	<input type="checkbox" class="custom-control-input" id="switch26" disabled>
																	<label class="custom-control-label" for="switch26"></label>
																</div>
															</td>
															<td class="pb-0">
																<div class="custom-control custom-switch">
																	<input type="checkbox" class="custom-control-input" id="switch28" disabled>
