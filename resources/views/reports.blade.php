								...
								<div class="header-menu-list d-flex bg-white rt_nav_header horizontal-layout nav-bottom">
									<div class="append mr-auto my-0 my-md-0 mr-auto">
										<ul class="list-group list-group-horizontal-md mr-auto">
											...
											<li class="mr-1 active"><a class="text-white btn-ctm-space" href="reports.html"><span class="lnr lnr-rocket pr-0 pr-lg-2"></span><span class="d-none d-lg-inline">Reports</span></a></li>
						...
						<div class="col-xl-3 col-lg-4 col-md-12 theiaStickySidebar">
							<aside class="sidebar sidebar-user">
								...
								<div class="quicklink-sidebar-menu ctm-border-radius shadow-sm bg-white card">
									<div class="card-body">
										<ul class="list-group">
											<li class="list-group-item text-center active"><a href="reports.html" class="text-white">Team Member Data</a></li>
											<li class="list-group-item text-center"><a class="text-dark" href="leave-reports.html">Leave Data</a></li>
											<li class="list-group-item text-center"><a class="text-dark" href="payroll-reports.html">Payroll Data</a></li>
											...
											<li class="list-group-item text-center"><a class="text-dark" href="security-reports.html">Security Reports</a></li>
