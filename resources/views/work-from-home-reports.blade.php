								...
								<div class="quicklink-sidebar-menu ctm-border-radius shadow-sm bg-white card">
									<div class="card-body">
										<ul class="list-group">
											...
											<li class="list-group-item text-center active"><a class="text-white" href="work-from-home-reports.html">Working From Home Reports</a></li>
										</ul>
									</div>
								</div>
							</aside>
							...
							<div class="card shadow-sm ctm-border-radius">
								<div class="card-body align-center">
									<div class="row filter-row">
										...
										<div class="col-sm-6 col-md-3">  
											<a href="#" class="btn btn-theme button-1 text-white btn-block p-2"> Apply Filter </a>  
										</div>
									</div>
								</div>
							</div>
