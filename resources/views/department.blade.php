										...
										<div
											...
											<a href="javascript:void(0)" data-toggle="dropdown"
												...
												<div class="user-avatar d-inline-block">
													<img src="{{ asset('assets/img/profiles/' . session('image')) }}"  alt="user avatar"
											...
											<div
												...
												</a> <a class="dropdown-item p-2" href="login.html"> <span
													class="media align-items-center"> <span
							...
							<div
								...
								<div class="append mr-auto my-0 my-md-0 mr-auto">
									<ul class="list-group list-group-horizontal-md mr-auto">
										...
										<li class="mr-1 active"><a
											class="text-white btn-ctm-space" href="company.html"><span
						...
						<aside class="sidebar sidebar-user">
							...
							<div class="card shadow-sm ctm-border-radius">
								<div class="card-header">
									...
									<a href="employees-team.html" class="float-right text-primary">Manage
										Teams</a>
								</div>
								<div class="card-body">
									<div class="row">
									...
									<div class="text-center">
										<a href="employees.html"
											class="btn btn-theme text-white ctm-border-radius mt-2 button-1">People
											Directory</a>
									</div>
								</div>
							</div>
							<div class="card ctm-border-radius shadow-sm">
								...
								<div class="card-body">
									...
									<a href="employment.html"><span class="avatar"
										data-toggle="tooltip" data-placement="top" title="Danny Ward"><img
											alt="avatar image" src="assets/img/profiles/img-5.jpg"
											class="img-fluid"></span></a> <a href="employment.html"><span
										class="avatar" data-toggle="tooltip" data-placement="top"
										title="Linda Craver"><img class="img-fluid"
											alt="avatar image" src="assets/img/profiles/img-4.jpg"></span></a>
									<a href="employment.html"><span class="avatar"
										data-toggle="tooltip" data-placement="top" title="Jenni Sims"><img
											class="img-fluid" alt="avatar image"
											src="assets/img/profiles/img-3.jpg"></span></a> <a
										href="employment.html"><span class="avatar"
										data-toggle="tooltip" data-placement="top"
										title="Maria Cotton"><img alt="avatar image"
											src="assets/img/profiles/img-6.jpg" class="img-fluid"></span></a>
									<a href="employment.html"><span class="avatar"
										data-toggle="tooltip" data-placement="top" title="John Gibbs"><img
											class="img-fluid" alt="avatar image"
											src="assets/img/profiles/img-2.jpg"></span></a> <a
										href="employment.html"><span class="avatar"
										data-toggle="tooltip" data-placement="top"
										title="Richard Wilson"><img class="img-fluid"
											alt="avatar image" src="assets/img/profiles/img-10.jpg"></span></a>
								</div>
							</div>
						</aside>
					</div>
						...
						<div class="row">
								...
								<div class="card ctm-border-radius shadow-sm flex-fill">
									<div class="card-header">
										<h4 class="card-title mb-0">
											Focus Technologies <a href="javascript:void(0)"
												class="float-right text-primary"><i
									...
									<div class="card-body">
										<div class="row">
											...
											<div class="col-md-6">
												<p>
													...
													Santiago de Surco <br> Av.Caminos del Inca 1325<br>
													United States
												</p>
										...
										<div class="text-center mt-3">
											<button
												...
												data-toggle="modal" data-target="#add-information">Add
									...
									<div class="card-body">
										<div class="input-group mb-3">
											...
											<div class="input-group-append">
												<button class="btn btn-theme text-white" type="button">
							...
							<div class="col-md-12">
								<div class="company-doc">
									<div class="card ctm-border-radius shadow-sm">
										<div class="card-header">
											<h4 class="card-title d-inline-block mb-0">Documents</h4>
											<a href="javascript:void(0)"
												class="float-right add-doc text-primary" data-toggle="modal"
														...
														<tbody>
															<tr>
																<td class="text-primary"><i
																	class="fa fa-file-pdf-o" data-toggle="tooltip"
																	data-placement="top" title="PDF" aria-hidden="true"></i></td>
																<td><a href="javascript:void(0)"
																	class="text-primary">Leave & Attendance Policy</a></td>
																<td>05 Jan 2019</td>
																<td>20 MB</td>
																<td class="text-right">
																	<div class="table-action">
																		<a href="javascript:void(0);"
																			...
																			class="lnr lnr-trash"></span> Delete
																		</a>
																	</div>
																</td>
															...
															<tr>
																<td class="text-primary"><i
																	...
																	data-placement="top" title="PDF" aria-hidden="true"></i></td>
																<td><a href="javascript:void(0)"
																	class="text-primary">Dress Code Policy</a></td>
																<td>10 May 2019</td>
																<td>30 MB</td>
																<td class="text-right">
																	<div class="table-action">
															...
															<tr>
																<td class="text-primary cursor-pointer"><i
																	class="fa fa-file-word-o" aria-hidden="true"
																	data-toggle="tooltip" data-placement="top" title="Word"></i></td>
																<td><a href="javascript:void(0)"
																	class="text-primary">ID Card Policy</a></td>
																<td>12 Jun 2019</td>
																<td>25 MB</td>
																<td class="text-right">
																	<div class="table-action">
															...
															<tr>
																<td class="text-primary"><i
																	...
																	data-placement="top" title="PDF" aria-hidden="true"></i></td>
																<td><a href="javascript:void(0)"
																	class="text-primary">Work From Home Policy</a></td>
																<td>05 Jul 2019</td>
																<td>10 MB</td>
																<td class="text-right">
																	<div class="table-action">
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<p>Offices allow you to group people by location. Offices can
						subscribe to different public holidays, helping you to localize
						people's time off allowances.</p>
					...
					<button type="button"
						class="btn btn-theme ctm-border-radius text-white float-right button-1">Add</button>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<button type="button"
						...
						data-dismiss="modal">Cancel</button>
					<button type="button"
						class="btn btn-theme text-white ctm-border-radius float-right">Save</button>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body style-add-modal">
					...
					<form action="{{ url('/addDepartment') }}" method="post">
						...
						<div class="form-group">
							<div class="input-group mb-3">
								<input class="form-control" type="text" name="department_name" placeholder="Department Name" value="{{ old('department_name') }}">
							</div>
						...
						<div class="form-group">
							<div class="input-group mb-3">
								<input class="form-control" type="email" name="contact_email" placeholder="Contact Email" value="{{ old('contact_email') }}">
							</div>
						...
						<div class="form-group">
							<div class="input-group mb-3">
								<input class="form-control" type="text" name="number_of_employees" placeholder="Number Of Employees" value="{{ old('number_of_employees') }}">
							</div>
						...
						<div class="form-group">
							<div class="input-group mb-3">
								<input class="form-control" type="text" name="head_of_department" placeholder="Head of Department" value="{{ old('head_of_department') }}">
							</div>
							@error('head_of_department') <small class="text-danger">{{ $message }}</small> @enderror
						</div>
					
						<div class="form-group">
							<div class="input-group mb-3">
								<input  type="text" name="established_date" placeholder="Established Date" value="{{ old('established_date') }}" onfocus="(this.type='date')" onblur="(this.type='text')">
							</div>
							@error('established_date') <small class="text-danger">{{ $message }}</small> @enderror
						</div>
					
						<div class="form-group">
							<div class="input-group mb-3">
								<input class="form-control" type="text" name="department_code" placeholder="Department Code" value="{{ old('department_code') }}">
							</div>
							@error('department_code') <small class="text-danger">{{ $message }}</small> @enderror
						</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<button type="button"
						...
						data-dismiss="modal">Cancel</button>
					<button type="button"
						class="btn btn-theme ctm-border-radius text-white float-right button-1">Upload</button>
				</div>
			</div>
		</div>
	</div>
