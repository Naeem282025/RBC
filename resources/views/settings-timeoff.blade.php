								...
								<div class="header-menu-list d-flex bg-white rt_nav_header horizontal-layout nav-bottom">
									<div class="append mr-auto my-0 my-md-0 mr-auto">
										<ul class="list-group list-group-horizontal-md mr-auto">
											...
											<li class="mr-1"><a class="text-dark btn-ctm-space" href="company.html"><span class="lnr lnr-apartment pr-0 pr-lg-2"></span><span class="d-none d-lg-inline">Department</span></a></li>
											...
											<li class="mr-1"><a class="text-dark btn-ctm-space" href="leave-details.html"><span class="lnr lnr-briefcase pr-0 pr-lg-2"></span><span class="d-none d-lg-inline">Leave</span></a></li>
						...
						<div class="col-xl-3 col-lg-4 col-md-12 theiaStickySidebar">
							<aside class="sidebar sidebar-user">
								...
								<div class="quicklink-sidebar-menu ctm-border-radius shadow-sm bg-white card">
									<div class="card-body">
										<ul class="list-group">
											<li class="list-group-item text-center button-6"><a href="settings.html" class="text-dark">General</a></li>
											<li class="list-group-item text-center active button-5"><a class="text-white" href="settings-timeoff.html">Time Off</a></li>
										</ul>
									</div>
								</div>
							</aside>
											...
											<div id="company-name">
												<div class="table-responsive bg-white">
													<table class="table">
														...
														<tbody>
															<tr>
																<td><a href="employment.html" class="text-primary"><span class="avatar" data-toggle="tooltip" data-placement="top" title="Maria Cotton"><img src="assets/img/profiles/img-6.jpg" alt="Maria Cotton" class="img-fluid"></span><span>Maria Cotton</span></a></td>
																<td>25</td>
																<td>20</td>
																<td>Robert Wilson</td>
															</tr>
