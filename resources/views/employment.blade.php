...
<html lang="en">
	...
	<body>
								...
								<div class="header-menu-list d-flex bg-white rt_nav_header horizontal-layout nav-bottom">
									<div class="append mr-auto my-0 my-md-0 mr-auto">
										<ul class="list-group list-group-horizontal-md mr-auto">
											...
											<li class="mr-1 active"><a class="text-white btn-ctm-space" href="settings.html"><span class="lnr lnr-cog pr-0 pr-lg-2"></span><span class="d-none d-lg-inline">Settings</span></a></li>
										</ul>
									</div>
						...
						<div class="col-xl-9 col-lg-8  col-md-12">
							...
							<div class="row">
								<div class="col-md-6 col-sm-12 d-flex">
									<div class="card add-team flex-fill ctm-border-radius shadow-sm">
										<div class="card-header">
											<h4 class="card-title mb-0">Add Maria Cotton to Another Team</h4>
										</div>
										<div class="card-body">
											...
											<button class="btn btn-theme button-1 ctm-border-radius text-white float-right" type="button" data-toggle="modal" data-target="#addNewTeam">New Team</button>
										</div>
									</div>
								</div>
								<div class="col-md-6 col-sm-12 d-flex">
									<div class="card office-card flex-fill ctm-border-radius shadow-sm">
										<div class="card-header d-flex justify-content-between align-items-center">
											<h4 class="d-inline-block card-title mb-0">PHP Team</h4>
											<div class="team-action-icon float-right">
												<span data-toggle="modal" data-target="#editNewTeam">
												<a href="javascript:void(0)" class="btn btn-theme ctm-border-radius text-white" title="Edit"><i class="fa fa-pencil"></i></a>
												</span>
												<span data-toggle="modal" data-target="#delete">
												<a href="javascript:void(0)" class="btn btn-theme ctm-border-radius text-white" title="Delete"><i class="fa fa-trash"></i></a>
												</span>
											</div>
										</div>
										<div class="card-body">
											<p class="d-inline-block mb-0">
												<a href="employment.html" class="avatar d-inline-block"><img src="assets/img/profiles/img-6.jpg" alt="Maria Cotton" class="img-fluid"></a>
												<a href="employment.html" class="d-inline-block ml-4 text-primary">Maria Cotton</a>
											</p>
										</div>
									</div>
								</div>
									...
									<div class="card ctm-border-radius shadow-sm">
										<div class="card-header">
											<div class="d-inline-block">
												...
												<span class="mb-0 ctm-text-sm">Head Office</span>
											</div>
											<a href="javascript:void(0)" class=" mt-2 btn btn-theme button-1 ctm-border-radius text-white float-right" data-toggle="modal" data-target="#changeOffice">Change Office </a>
										</div>
										<div class="card-body">
											...
											<a href="javascript:void(0)" class="btn btn-theme button-1 text-white ctm-border-radius float-right mx-2  mt-2"> Visit Office</a>
										</div>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6 col-sm-12 d-flex">
									<div class="card flex-fill ctm-border-radius shadow-sm">
										<div class="card-header">
											<h4 class="card-title mb-0">Maria Cotton's Manager</h4>
										</div>
										<div class="card-body">
											<div class="media mb-4">
												<img class="rounded mr-3 img-fluid" src="assets/img/profiles/img-10.jpg" alt="avatar image" width="50" height="50">
												<div class="media-body">
													<a href="employment.html" class="text-dark text-ellipsis">Richard Wilson</a>
													<p class="ctm-text-sm mb-0 text-ellipsis">richardwilson@example.com</p>
												</div>
											</div>
											<div class="text-center">
												<a href="javascript:void(0)" class="btn btn-theme button-1 ctm-border-radius text-white" data-toggle="modal" data-target="#changeManger">Change Manager</a>
											</div>
										</div>
									</div>
								</div>
								<div class="col-md-6 col-sm-12 d-flex">
									<div class="card add-team flex-fill ctm-border-radius shadow-sm">
										<div class="card-header">
											<h4 class="card-title mb-0">Who Reports to Maria Cotton</h4>
										</div>
										<div class="card-body">
											<a href="employment.html"><span class="avatar" data-toggle="tooltip" data-placement="top" title="John Gibbs"><img class="img-fluid" alt="avatar image" src="assets/img/profiles/img-2.jpg"></span></a>
											<a href="employment.html"><span class="avatar" data-toggle="tooltip" data-placement="top" title="Richard Wilson"><img class="img-fluid" alt="avatar image" src="assets/img/profiles/img-10.jpg"></span></a>
											<div class="text-center">
												<a href="javascript:void(0)" class="btn btn-theme button-1 ctm-border-radius text-white mt-4" data-toggle="modal" data-target="#addPeople">Add People</a>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col-md-6 col-sm-12 d-flex">
									<div class="card flex-fill ctm-border-radius shadow-sm">
										...
										<div class="card-body">
											...
											<div class="form-group">
												<input type="text" class="form-control" placeholder="Employment Type" value="Permanent">
											</div>
											<div class="team-action-icon float-right">
											...
											<p class="btn btn-theme ctm-border-radius text-white mb-1">PHP Team Lead</p>
											<p class="btn btn-theme ctm-border-radius text-white mb-1">Permanent</p>
										</div>
									</div>
								</div>
								<div class="col-md-6 col-sm-12 d-flex">
									<div class="card flex-fill office-card-last ctm-border-radius shadow-sm">
										<div class="card-header ">
		...
		<!-- New Team The Modal -->
		<div class="modal fade" id="editNewTeam">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					<!-- Modal body -->
					<div class="modal-body">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h4 class="modal-title mb-3">Change Team</h4>
						<div class="form-group">
							<select class="form-control select">
								<option>Select Team</option>
								<option selected value="1">PHP</option>
								<option value="2">IOS</option>
								<option value="3">Design</option>
								<option value="4">Testing</option>
								<option value="5">Business</option>
		...
		<!-- Edit Employment Position The Modal -->
		<div class="modal fade" id="edit_position">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<div class="modal-body">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
						<h4 class="modal-title mb-3">Edit Position</h4>
						<div class="form-group">
							<input type="text" class="form-control" placeholder="Job Title" value="PHP Team Lead">
						</div>
						<div class="form-group">
							<input type="text" class="form-control" placeholder="Employment Type" value="Permanent">
						</div>
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<button type="button" class="btn btn-danger text-white ctm-border-radius text-center mb-2 mr-3" data-dismiss="modal">Cancel</button>
						<button type="button" class="btn btn-theme button-1 text-white ctm-border-radius text-center mb-2" data-dismiss="modal">Delete</button>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<select class="select form-control">
								...
								<option value="1">Richard Wilson</option>
